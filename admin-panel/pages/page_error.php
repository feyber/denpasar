          ...
          <div class="col-md-12" style="margin-top: 10%">
              <div class="col-middle">
                  <div class="text-center">
                      <h1 class="error-number">Page Not Found</h1>
                      <h2>Cannot Find The Page</h2>
                      <p>
                        Sorry, your page not found from our website, try another page or try to click link Homepage
                      </p>
                  </div>

                  <p align="center" style="margin-top: 20px;">
                      <a href="../admin-panel" class="btn btn-default btn-round">Homepage</a>
                  </p>
              </div>
          </div>
          <!-- /page content -->
