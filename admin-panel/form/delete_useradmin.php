...
<div class="container-form" style="padding-top:70px;">
	...
	<h4><strong><?php echo $useradmin['name'] ?></strong></h4>
    <form action="" method="post" class="on_submit form-horizontal form-label-left">
        ...
        <div style="margin-top:30px;">
            ...
            <input type="button" class="btn btn-default" value="No" onClick="document.location='<?php echo BaseURL() ?>/useradmin';" />
        </div>
	</form>
</div>
<script>
	function onsubmitdata(){
		$.post("<?php echo BaseURL() ?>/form/process_delete_useradmin.php",$(".on_submit").serialize(),function(data){
