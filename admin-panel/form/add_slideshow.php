<div class="container-form">
    ...
    <form action="<?php echo BaseURL() ?>/form/process_add_slideshow.php" method="post" enctype="multipart/form-data" class="on_submit form-horizontal form-label-left">
        ...
        <div class="form-group">
            <div class="col-md-9 col-sm-9 col-xs-9">
                <input type="text" class="form-control has-feedback-left" placeholder="Title Of Picture" name="title" />
