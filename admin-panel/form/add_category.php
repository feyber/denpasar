    ...
    <form action="" method="post" class="on_submit form-horizontal form-label-left">
        <div class="form-group">
            <div class="col-md-9 col-sm-9 col-xs-9">
                <input type="text" class="form-control has-feedback-left" placeholder="Category Winning" name="catwinning" required />
...
<script>
	function onsubmitdata(){
		$.post("<?php echo BaseURL() ?>/form/process_add_category.php",$(".on_submit").serialize(),function(data){
