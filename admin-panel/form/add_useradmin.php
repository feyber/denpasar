<div class="container-form">
    ...
    <form action="<?php echo BaseURL() ?>/form/process_add_useradmin.php" method="post" enctype="multipart/form-data" class="on_submit form-horizontal form-label-left">
        ...
        <div class="form-group">
            <div class="col-md-9 col-sm-9 col-xs-9">
                <input type="text" class="form-control has-feedback-left" placeholder="Full Name" name="full_name" />
        ...
        <div class="form-group">
            <div class="col-md-9 col-sm-9 col-xs-9">
                <input type="password" class="form-control has-feedback-left" placeholder="Password" name="password" />
        ...
        <div style="position:absolute;float:right;top:14%;right:15%;">
            <div class="fileinput fileinput-new" data-provides="fileinput">
                ...
                <div class="fileinput-preview fileinput-exists thumbnail" style="width:200px;height:180px;"></div>
                <div>
